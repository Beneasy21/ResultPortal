...
$RegNo = stripslashes($_POST["RegNo"]); //Storing Reg Numberin $regNo variable.
$Session = stripslashes($_POST["AcadYr"]);//Storing Acad Year in $Session variable
$Term = stripslashes($_POST["Term"]); //Storing Term in $Term variable.
$Class = stripslashes($_POST["Class"]); //Storing Class in $Class variable.
$House = ""; //Storing Class in $Class variable.
					...
					$RegNo = mysqli_real_escape_string($conn,$_POST["RegNo"]); //Storing Reg Numberin $regNo variable.
					$Session = mysqli_real_escape_string($conn,$_POST["AcadYr"]);//Storing Acad Year in $Session variable
					$Term = mysqli_real_escape_string($conn,$_POST["Term"]); //Storing Term in $Term variable.
					$Class = mysqli_real_escape_string($conn,$_POST["Class"]); //Storing Class in $Class variable.
	...
	<table bgcolor=white width="800" align=center height="1000">
		...
		<tr>
			...
			<?php 
				...
				echo "'".$Term."' Term '".$Session."' Academic Session";
		...
		<tr>
			<td height="120">
				...
				<table align=center border="1" width="90%" height="120">
					...
					<td width = "16%" align="Center" rowspan="3"><img src ="PassPort"></td></tr>
					
					<tr><td width = "14%"" align="right"><strong><i>Admin No:</i></td><td bgcolor="#B8DEE9" class="style3" width="18"><div align="left" class="style9 style6"><strong><?php  echo $House;?></strong></div></td>
					...
					<td width = "14%" align="right"><strong><i>Session:</i></strong></td><td bgcolor="#B8DEE9" class="style3"><div align="left" class="style9 style6"><strong><?php echo $Session;?></strong></div></td>
		...
		<tr>
			<td>
				<?php
					...
					// Specify the query to execute
					$sql = "select *  from results where studId = '".$RegNo."' AND acadYr = '".$Session."' AND term = '".$Term."' AND arm = '".$Arm."'ORDER BY `resClass`,
					 CASE `subjects`
					 WHEN 'English Language' THEN 1
					 WHEN 'Mathematics' THEN 2
					 WHEN 'Civic Education' THEN 3
					 ELSE 4
					 END";
					// Execute query
		...
		<tr>
			<td>
				<?php
					...
					// Specify the query to execute
					$sql = "select SUM(examTotal), AVG(examTotal) FROM results WHERE studId = '".$RegNo."' AND acadYr = '".$Session."' AND term = '".$Term."' AND arm = '".$Arm."'";
					...
					<tr><td>
					<?php include "includes/comment32.php";?></strong>
