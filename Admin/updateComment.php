...
<title>House Parent Comments</title>
</head>
	...
	if (mysqli_query ($con,$sql))
		{
			 ...
			 echo '<script type="text/javascript">alert("House Parent Comment added Succesfully");window.location=\'toAddComments.php\';</script>';
		}
		 else
		 {
