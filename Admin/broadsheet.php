	        ...
	        <div id="TabbedPanels1" class="TabbedPanels">
				...
				<table align= "center" width = "80%" >
						...
						<tr>    
								...
								echo "<td  valign='buttom' ALIGN = 'CENTER'><strong> <FONT SIZE = '3'> COMMAND SECONDARY SCHOOL - IPAJA </FONT> </br>
										<strong> <FONT SIZE = '4.5'> FORM MASTER'S RECORD $Term Term, $academicYear SESSION </FONT></br>
									  Class: $CurrentClass 	   Arm: $Arm  </br>Subject Combination: $Combination</strong>";?>
						</tr>
				</table>
