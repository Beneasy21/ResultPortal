...
$Class = stripslashes($_POST["studClass"]); //Storing Class in $Class variable.
$House = ""; //Storing Class in $Class variable.
					...
					$Class = mysqli_real_escape_string($conn,$_POST["studClass"]); //Storing Class in $Class variable.
		...
		<tr>
			<td>
				<?php
					...
					// Specify the query to execute
					$sql = "select SUM(examTotal), AVG(examTotal) FROM results WHERE studId = '".$RegNo."' AND acadYr = '".$Session."' AND term = '".$Term."' AND arm = '".$Armm."'";
					// Execute query
