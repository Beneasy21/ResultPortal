...
$Class = $_POST["studClass"]; //Storing Class in $Class variable.
	...
	<table  width=1300 align=center >
		...
		<tr>
		<td>
	<H3><table width="100%" border="1" bordercolor="#85A157" align="center">
		<thead>
			...
			<td>
				<?php
					...
					<table border = "1" width = "70%" height='40'align="center">
						...
						<tr ><H2>
							<td align="right"><strong> Annual Total Score:</strong></td> <td  ><strong><?php echo $TotalScore;?></strong></td>
							<td align="right"><strong> Annual Average Score:</strong></td> <td  ><strong><?php echo round($AverageScore,2);?></strong></td>
						</tr></H2>
						<tr >
					...
					<tr><td><font size='4'>
					<?php include "includes/annualComment3Promoted.php";?></strong></font>
