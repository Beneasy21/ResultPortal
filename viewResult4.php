...
students.currentClass='".$ClassViewed."' AND results.subjects = '".$SubjectViewed."' AND results.acadYr = '".$AcademicYear."' AND results.term = '".$TermViewed."' AND students.arm='".$ArmViewed."' ORDER BY results.studId DESC" ;
                    ...
                    <tr>
                      <td colspan="8" class="style3">
					  	<div align="left" class="style12">
							...
							<input type="hidden" name="arm" value="<?=$ArmViewed?>"/>
							<input type="hidden" name="academicYear" value="<?=$AcademicYear?>"/>
							<input type="hidden" name="Term" value="<?=$TermViewed?>"/>
							<input type="hidden" name="Subject" value="<?=$SubjectViewed?>"/>
					  	</div>
					  </td>
                    </tr>
                    <?php
