...
<?php
    ...
    $row=mysqli_fetch_array($sql1);
		...
		if($row['studId']!=$AdmNo)	
		{
			if(mysqli_query ($conn,"INSERT INTO students 	(studId,studName,sex,currentClass,arm) 
				values('".$AdmNo."','".$Name."','".$Sex."','".$Class."','".$Arm."')"))
				{
	      		echo '<script type="text/javascript">alert("New Student Inserted Succesfully");window.location=\'AddStudent.html\';</script>';
				}
		}
		else 
		{
